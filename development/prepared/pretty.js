...
_a.requests = {
  ...
  make_mini_game_session_id : function() { 
    ...
    return 'C'+_a.globals.window.casper
         +"-G"+_a.globals.window.mufasa
...
{
  let function_id_char = _a.encr.random_char( "bfjnrvzDHLPTX159", 223+score, 10, 16 )
...
{
  let function_id_char = _a.encr.random_char( "cgkoswAEIMQUY26+", 144+score, 11, 16 )
...
{
  let function_id_char = _a.encr.random_char( "dhlptxBFJNRVZ37/", 151+score, 12, 16 )
...
{
  let function_id_char = _a.encr.random_char( "bfjnrvzDHLPTX159", 179+score, 8, 16 )
...
{
  let function_id_char = _a.encr.random_char( "cgkoswAEIMQUY26+", 156+score, 14, 16 )
...
{
  let function_id_char = _a.encr.random_char( "dhlptxBFJNRVZ37/", 147+score, 8, 16 )
...
{
  let function_id_char = _a.encr.random_char( "bfjnrvzDHLPTX159", 195+score, 14, 16 )
...
{
  let function_id_char = _a.encr.random_char( "cgkoswAEIMQUY26+", 190+score, 11, 16 )
...
{
  let function_id_char = _a.encr.random_char( "bfjnrvzDHLPTX159", 174+score, 8, 16 )
...
{
  let function_id_char = _a.encr.random_char( "cgkoswAEIMQUY26+", 208+score, 13, 16 )
...
{
  let function_id_char = _a.encr.random_char( "dhlptxBFJNRVZ37/", 231+score, 15, 16 )
...
{
  let function_id_char = _a.encr.random_char( "bfjnrvzDHLPTX159", 219+score, 12, 16 )
...
{
  let function_id_char = _a.encr.random_char( "cgkoswAEIMQUY26+", 247+score, 7, 16 )
...
{
  let function_id_char = _a.encr.random_char( "dhlptxBFJNRVZ37/", 219+score, 7, 16 )
  let character_positions = [2,7,19,20,26,32,34]
  let offset = 701
